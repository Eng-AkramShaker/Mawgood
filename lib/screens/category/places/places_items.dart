...
class _ShowAllPlacesState extends State<ShowAllPlaces> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer4<Auth_Provider, Places_Controller, Favorite_Controller, Profile_Provider>(
      builder: (context, pro_Auth, pro_Places, pro_Favorite, pro_Profile, child) {
        return Scaffold(
