...
class _DetailsScreenState extends State<Details_Screen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDetailsContent(Auth_Provider authProvider, Places_Controller placesProvider, Size size) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        if (authProvider.guest != 'eng.akramsh@gmail.com')
          //
          _build_Star_Rating(show_id: widget.show_id),
        SizedBox(height: 10),
  ...
  Widget _build_Star_Rating({required show_id}) {
        ...
        child: Center(
          child: RatingBar.builder(
            ...
            onRatingUpdate: (rating) {
              ...
              pro_Places.Send_Rating(context, pro_Auth.user!.data!.token!, widget.show_id, '$_currentRating');
