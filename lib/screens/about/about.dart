...
class _Contact_Us_ScreenState extends State<About_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer5<Auth_Provider, Profile_Provider, Favorite_Controller,
        Contact_us_Controller, Privacy_About_Controller>(
      builder: (context, provAuth, proProfile, proFavorite, proContact_us,
          pro_Privacy_About, child) {
        return SafeArea(
          child: Scaffold(
            appBar: AppBar(),
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(
                              ...
                              child: Text(pro_Privacy_About
                                      .List_Privacy_About!.data!.aboutUs! ??
                                  ''),
                            )),
                          ),
                        ],
